...
<div className="rounded-xl flex justify-center items-center bg-white pt-5" >
  <img width={1200} className="rounded-xl pt-10"  src="https://rukminim1.flixcart.com/fk-p-flap/600/150/image/619a7f2ea1915a1e.jpg?q=90" alt="" />
</div>
<div>
  <div className="rounded-xl justify-center items-center bg-white  flex flex-initial">
    <img width={600} src="https://rukminim1.flixcart.com/fk-p-flap/700/500/image/e82d3508e6695060.jpg?q=90" alt="" />
     <img width={600} src="https://rukminim1.flixcart.com/fk-p-flap/700/500/image/9fb2ef1bee40a63e.jpg?q=90" alt="" />
  </div>
</div>
